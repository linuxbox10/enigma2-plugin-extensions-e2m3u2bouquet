# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/E2m3u2bouquet/about.py
import os
import sys
...
class E2m3u2b_About(Screen):
    ...
    def __init__(self, session):
        ...
        self['about'] = Label('')
        self['actions'] = ActionMap(['SetupActions', 'ColorActions', 'MenuActions'], {'red': self.keyCancel,
